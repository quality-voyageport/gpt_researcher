...
class GPTResearcher:
    ...
    GPT Researcher
    """
    def __init__(self, query, report_type= 'research_report', config_path=None, websocket=None, feedback=None, gsheet_prompt=None):
        """
        ...
        self.gsheet_prompt = gsheet_prompt
    ...
    async def run(self):
        ...
        """
        JD:
            - This is the method that generates the report (obviously using the prompt)
        """
        report = await generate_report(query=self.query, context=self.context,
                                       ...
                                       feedback= self.feedback, gsheet_prompt= self.gsheet_prompt)             # JD                        ***
        time.sleep(2)
        return report
